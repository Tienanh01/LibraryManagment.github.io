...
public class ReturnBook extends JFrame implements ActionListener{
    ...
    public void delete() {
        ...
        conn con = new conn();
        DeleteBookController dl = new DeleteBookController();
        int i = dl.DeleteBook(book_id);
        if (i > 0)
	...
	contentPane.add(lblName);
        ...
        JLabel lblCourse = new JLabel("Hệ");
	lblCourse.setForeground(Color.BLACK);
	lblCourse.setFont(new Font("Time new roman", Font.BOLD, 14));
	lblCourse.setBounds(52, 143, 87, 24);
	contentPane.add(lblCourse);

        JLabel lblBranch = new JLabel("Ngành học");
	lblBranch.setForeground(Color.BLACK);
	lblBranch.setFont(new Font("Time new roman", Font.BOLD, 12));
	lblBranch.setBounds(303, 144, 68, 24);
	contentPane.add(lblBranch);

	JLabel lblDateOfIssue = new JLabel("Ngày mượn");
	lblDateOfIssue.setForeground(Color.BLACK);
	lblDateOfIssue.setFont(new Font("Time new roman", Font.BOLD, 14));
	lblDateOfIssue.setBounds(52, 188, 105, 29);
	contentPane.add(lblDateOfIssue);

	JLabel lblDateOfReturn = new JLabel("Ngày trả");
	lblDateOfReturn.setForeground(Color.BLACK);
	lblDateOfReturn.setFont(new Font("Time new roman", Font.BOLD, 14));
	lblDateOfReturn.setBounds(52, 234, 118, 29);
	contentPane.add(lblDateOfReturn);

        textField = new JTextField();
	textField.setForeground(new Color(105, 105, 105));
	textField.setFont(new Font("Time new roman", Font.BOLD, 14));
	...
	textField_1.setFont(new Font("Time new roman", Font.BOLD, 14));
	...
	textField_2.setFont(new Font("Time new roman", Font.BOLD, 13));
	...
	textField_3.setFont(new Font("Time new roman", Font.BOLD, 13));
	...
	textField_4.setFont(new Font("Time new roman", Font.BOLD, 13));
	...
	textField_5.setFont(new Font("Time new roman", Font.BOLD, 13));
	...
	textField_6.setFont(new Font("Time new roman", Font.BOLD, 13));
	...
	panel.setBorder(new TitledBorder(new LineBorder(new Color(255, 69, 0), 2, true), "Trả sách",
    ...
    public void actionPerformed(ActionEvent ae){
		...
		rs.close();
            ...
            if(ae.getSource() == b2){
                String sql = "insert into returnBook(book_id, student_id, bname, sname,course, Nganhhoc, dateOfIssue, dateOfReturn) values(?, ?, ?, ?, ?, ?, ?, ?)";
		PreparedStatement st = con.c.prepareStatement(sql);
		...
		if (i > 0) {
                    JOptionPane.showMessageDialog(null, "Đang thực hiện..");
                    delete();
		} else
