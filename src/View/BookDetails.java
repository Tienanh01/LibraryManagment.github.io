...
//	b2.addActionListener(this);
        ...
        JLabel l1 = new JLabel("Chi tiết sách");
        l1.setForeground(new Color(107, 142, 35));
        l1.setFont(new Font("Time new roman", Font.BOLD | Font.ITALIC, 30));
        ...
        panel.setBorder(new TitledBorder(new LineBorder(new Color(0, 128, 128), 3, true), "Chi tiết sách",
...
//        if(ae.getSource() == b2){
//            JOptionPane.showMessageDialog(this, "Bnạ dã chạm vào nút xóa");
//        }
        try {
            conn con = new conn();
            if (ae.getSource() == b2) {
                JOptionPane.showMessageDialog(this, "Bạn đã chạm vào nút xóa");
//                 '" + search.getText() + "'
//                 String sql = "delete from book where name = otomat";
//		PreparedStatement st = con.c.prepareStatement(sql);
////                                    int rs = st.executeUpdate();
//                                    
//		JDialog.setDefaultLookAndFeelDecorated(true);
//		int response = JOptionPane.showConfirmDialog(null, "Bạn có muốn xóa không", "Xác nhận",
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {
        try {
            ...
            if (response == JOptionPane.YES_OPTION) {
                ...
                setVisible(false);
                BookDetails booksd= new BookDetails();
                booksd.setVisible(true);
            }
            st.close();
