...
public class Statistics extends JFrame{
	...
	panel.setBorder(new TitledBorder(new LineBorder(new Color(47, 79, 79), 2, true), "Danh sách mượn",
...
Dimension objDimension = Toolkit.getDefaultToolkit().getScreenSize();
	...
	l1.setFont(new Font("Time new roman", Font.BOLD, 18));
	...
	table_1.setFont(new Font("Time new roman", Font.BOLD, 12));
	scrollPane_1.setViewportView(table_1);

	JPanel panel_1 = new JPanel();
	panel_1.setBorder(new TitledBorder(new LineBorder(new Color(0, 204, 153), 2, true), "Danh sách trả",
