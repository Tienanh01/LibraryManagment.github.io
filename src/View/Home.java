...
public class Home extends JFrame implements ActionListener{
	...
	public static void main(String[] args) {
        ...
        public Home(){
            ...
            menuBar.setBounds(0, 10, 900, 35);
            contentPane.add(menuBar);

            JMenu mnExit = new JMenu("Thoát");
            mnExit.setFont(new Font("Time new roman", Font.BOLD, 17));
...
//            
            ...
            mnHelp.setFont(new Font("Time new roman", Font.BOLD, 17));
            

            JMenuItem mntmReadme = new JMenuItem("Update Student");
             mntmReadme.addActionListener(new java.awt.event.ActionListener() {
            ...
            JMenuItem mntmAboutUs = new JMenuItem("Update Book");
            ...
            JMenu mnRecord = new JMenu("Bản ghi");
            mnRecord.setFont(new Font("Time new roman", Font.BOLD, 17));
            ...
            JLabel l1 = new JLabel("Hệ thống Quản lý thư viện");
            ...
            panel.setBorder(new TitledBorder(new LineBorder(new Color(250, 128, 114), 2), "Hoạt động", TitledBorder.LEADING,
            ...
            b6 = new JButton("Thông tin liên hệ");
		...
		new Login_user().setVisible(true);
            ...
            else if(msg.equals("Update Book")){
                setVisible(false);
