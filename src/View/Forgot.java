...
public class Forgot extends JFrame implements ActionListener{
	...
	JLabel l1 = new JLabel("Tên tài khoản");
	l1.setFont(new Font("Time new roman", Font.BOLD, 13));
	l1.setBounds(109, 83, 87, 29);
	contentPane.add(l1);

	JLabel l2 = new JLabel("Tên");
	l2.setFont(new Font("Time new roman", Font.BOLD, 13));
	l2.setBounds(109, 122, 75, 21);
	contentPane.add(l2);

	JLabel l3 = new JLabel("Câu hỏi riêng tư");
	l3.setFont(new Font("Time new roman", Font.BOLD, 13));
	l3.setBounds(109, 154, 156, 27);
	contentPane.add(l3);

	JLabel l4 = new JLabel("Câu trả lời");
	l4.setFont(new Font("Time new roman", Font.BOLD, 13));
	l4.setBounds(109, 192, 104, 21);
	contentPane.add(l4);

	JLabel l5 = new JLabel("Mật khẩu");
	l5.setFont(new Font("Time new roman", Font.BOLD, 13));
	l5.setBounds(109, 224, 104, 21);
	contentPane.add(l5);

	t1 = new JTextField();
	t1.setFont(new Font("Time new roman", Font.BOLD, 13));
	...
	t2.setFont(new Font("Time new roman", Font.BOLD, 13));
	...
	t3.setFont(new Font("Time new roman", Font.BOLD, 12));
	...
	t4 = new JTextField();
	t4.setFont(new Font("Time new roman", Font.BOLD, 13));
	...
	t5.setFont(new Font("Time new roman", Font.BOLD, 13));
	...
	b1.setFont(new Font("Time new roman", Font.BOLD, 12));
	...
	b2.setFont(new Font("Time new roman", Font.BOLD, 12));
	...
	panel.setBorder(new TitledBorder(new LineBorder(new Color(139, 69, 19), 2), "Quên mật khẩu",
			TitledBorder.LEADING, TitledBorder.TOP, null, new Color(178, 34, 34)));
	panel.setBounds(47, 17, 508, 310);
    ...
    public void actionPerformed(ActionEvent ae){
		...
		while (rs.next()) {
            ...
            if(ae.getSource() == b2){
            if(t5.getText()== null){
                JOptionPane.showMessageDialog(this, "Bạn chưa nhập đáp án");
            }else{
